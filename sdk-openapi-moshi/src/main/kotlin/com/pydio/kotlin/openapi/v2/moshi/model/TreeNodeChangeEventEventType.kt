...
enum class TreeNodeChangeEventEventType(val value: kotlin.String) {
  ...
  @Json(name = "UPDATE_PATH") UPDATE_PATH("UPDATE_PATH"),
  @Json(name = "UPDATE_CONTENT") UPDATE_CONTENT("UPDATE_CONTENT"),
  @Json(name = "UPDATE_META") UPDATE_META("UPDATE_META"),
  @Json(name = "UPDATE_USER_META") UPDATE_USER_META("UPDATE_USER_META"),
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? =
        if (data is TreeNodeChangeEventEventType) "$data" else null

    /** Returns a valid [TreeNodeChangeEventEventType] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): TreeNodeChangeEventEventType? =
        data?.let {
