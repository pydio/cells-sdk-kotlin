...
open class ApiClient(val baseUrl: String, val client: Call.Factory = defaultClient) {
  companion object {
    ...
    const val baseUrlKey: String = "com.pydio.kotlin.openapi.v2.moshi.baseUrl"
                ...
                .apply {
                  ...
                  (content as Map<String, PartConfig<*>>).forEach { (name, part) ->
                    if (part.body is File) {
                      ...
                      addPart(
                          partHeaders.toHeaders(), parameterToString(part.body).toRequestBody(null))
                    }
                  }
                }
                .build()
  ...
  protected inline fun <reified I, reified T : Any?> request(
    ...
    return response.use {
      when {
        ...
        it.isClientError ->
            ClientError(it.message, it.body?.string(), it.code, it.headers.toMultimap())
