...
package com.pydio.kotlin.openapi.v2.moshi.api

import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ApiClient
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ApiResponse
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ClientError
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ClientException
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.MultiValueMap
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.RequestConfig
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.RequestMethod
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ResponseType
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ServerError
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.ServerException
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.Success
import com.pydio.kotlin.openapi.v2.moshi.infrastructure.toMultiValue
...
import com.pydio.kotlin.openapi.v2.moshi.model.RestActionParameters
import com.pydio.kotlin.openapi.v2.moshi.model.RestBackgroundAction
import com.pydio.kotlin.openapi.v2.moshi.model.RestBatchUpdateMetaList
...
import com.pydio.kotlin.openapi.v2.moshi.model.RestNamespaceValuesOperation
import com.pydio.kotlin.openapi.v2.moshi.model.RestNamespaceValuesResponse
import com.pydio.kotlin.openapi.v2.moshi.model.RestNode
import com.pydio.kotlin.openapi.v2.moshi.model.RestNodeCollection
import com.pydio.kotlin.openapi.v2.moshi.model.RestNodeUpdates
import com.pydio.kotlin.openapi.v2.moshi.model.RestPerformActionResponse
import com.pydio.kotlin.openapi.v2.moshi.model.RestPublicLinkDeleteSuccess
import com.pydio.kotlin.openapi.v2.moshi.model.RestPublicLinkRequest
import com.pydio.kotlin.openapi.v2.moshi.model.RestSelection
import com.pydio.kotlin.openapi.v2.moshi.model.RestShareLink
import com.pydio.kotlin.openapi.v2.moshi.model.RestUserMetaList
import com.pydio.kotlin.openapi.v2.moshi.model.RestUserMetaNamespaceCollection
...
class NodeServiceApi(
  ...
  fun backgroundActionInfo(
      name: NameBackgroundActionInfo,
  ...
  fun backgroundActionInfoWithHttpInfo(
      name: NameBackgroundActionInfo,
      jobUuid: kotlin.String
  ): ApiResponse<RestBackgroundAction?> {
    val localVariableConfig = backgroundActionInfoRequestConfig(name = name, jobUuid = jobUuid)

    return request<Unit, RestBackgroundAction>(localVariableConfig)
  }
   ...
   */
  fun backgroundActionInfoRequestConfig(
      name: NameBackgroundActionInfo,
      jobUuid: kotlin.String
  ): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/n/action/{Name}/{JobUuid}"
                .replace("{" + "Name" + "}", encodeURIComponent(name.value.toString()))
                .replace("{" + "JobUuid" + "}", encodeURIComponent(jobUuid.toString())),
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun batchUpdateMetaWithHttpInfo(
      body: RestBatchUpdateMetaList
  ): ApiResponse<RestBatchUpdateMetaList?> {
    val localVariableConfig = batchUpdateMetaRequestConfig(body = body)

    return request<RestBatchUpdateMetaList, RestBatchUpdateMetaList>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun batchUpdateMetaRequestConfig(
      body: RestBatchUpdateMetaList
  ): RequestConfig<RestBatchUpdateMetaList> {
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun controlBackgroundAction(
      name: NameControlBackgroundAction,
      jobUuid: kotlin.String,
      command: JobsCtrlCommand
  ): RestBackgroundAction {
    val localVarResponse =
        controlBackgroundActionWithHttpInfo(name = name, jobUuid = jobUuid, command = command)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun controlBackgroundActionWithHttpInfo(
      name: NameControlBackgroundAction,
      jobUuid: kotlin.String,
      command: JobsCtrlCommand
  ): ApiResponse<RestBackgroundAction?> {
    val localVariableConfig =
        controlBackgroundActionRequestConfig(name = name, jobUuid = jobUuid, command = command)

    return request<JobsCtrlCommand, RestBackgroundAction>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun controlBackgroundActionRequestConfig(
      name: NameControlBackgroundAction,
      jobUuid: kotlin.String,
      command: JobsCtrlCommand
  ): RequestConfig<JobsCtrlCommand> {
  ...
  fun createWithHttpInfo(body: RestCreateRequest): ApiResponse<RestNodeCollection?> {
    ...
    return request<RestCreateRequest, RestNodeCollection>(localVariableConfig)
  }
  ...
  fun createCheckWithHttpInfo(body: RestCreateCheckRequest): ApiResponse<RestCreateCheckResponse?> {
    ...
    return request<RestCreateCheckRequest, RestCreateCheckResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun createCheckRequestConfig(
      body: RestCreateCheckRequest
  ): RequestConfig<RestCreateCheckRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun createPublicLink(
    ...
    val localVarResponse =
        createPublicLinkWithHttpInfo(uuid = uuid, publicLinkRequest = publicLinkRequest)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun createPublicLinkWithHttpInfo(
      uuid: kotlin.String,
      publicLinkRequest: RestPublicLinkRequest
  ): ApiResponse<RestShareLink?> {
    val localVariableConfig =
        createPublicLinkRequestConfig(uuid = uuid, publicLinkRequest = publicLinkRequest)

    return request<RestPublicLinkRequest, RestShareLink>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun createPublicLinkRequestConfig(
      uuid: kotlin.String,
      publicLinkRequest: RestPublicLinkRequest
  ): RequestConfig<RestPublicLinkRequest> {
    ...
    return RequestConfig(
        method = RequestMethod.POST,
        path =
            "/n/node/{Uuid}/link".replace("{" + "Uuid" + "}", encodeURIComponent(uuid.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = true,
        body = localVariableBody)
  ...
  fun createSelectionWithHttpInfo(body: RestSelection): ApiResponse<RestSelection?> {
    ...
    return request<RestSelection, RestSelection>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun deletePublicLinkWithHttpInfo(
      linkUuid: kotlin.String
  ): ApiResponse<RestPublicLinkDeleteSuccess?> {
    val localVariableConfig = deletePublicLinkRequestConfig(linkUuid = linkUuid)

    return request<Unit, RestPublicLinkDeleteSuccess>(localVariableConfig)
  }
  ...
  fun deletePublicLinkRequestConfig(linkUuid: kotlin.String): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/n/link/{LinkUuid}"
                .replace("{" + "LinkUuid" + "}", encodeURIComponent(linkUuid.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = true,
        body = localVariableBody)
  ...
  fun getByUuidWithHttpInfo(uuid: kotlin.String, path: kotlin.String?): ApiResponse<RestNode?> {
    ...
    return request<Unit, RestNode>(localVariableConfig)
  }
  ...
  fun getPublicLinkWithHttpInfo(linkUuid: kotlin.String): ApiResponse<RestShareLink?> {
    ...
    return request<Unit, RestShareLink>(localVariableConfig)
  }
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun listNamespaceValues(
      namespace: kotlin.String,
      operationOperation: OperationOperationListNamespaceValues =
          OperationOperationListNamespaceValues.PUT,
      operationValues: kotlin.collections.List<kotlin.String>
  ): RestNamespaceValuesResponse {
    val localVarResponse =
        listNamespaceValuesWithHttpInfo(
            namespace = namespace,
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listNamespaceValuesWithHttpInfo(
      namespace: kotlin.String,
      operationOperation: OperationOperationListNamespaceValues,
      operationValues: kotlin.collections.List<kotlin.String>
  ): ApiResponse<RestNamespaceValuesResponse?> {
    val localVariableConfig =
        listNamespaceValuesRequestConfig(
            namespace = namespace,
            operationOperation = operationOperation,
            operationValues = operationValues)

    return request<Unit, RestNamespaceValuesResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun listNamespaceValuesRequestConfig(
      namespace: kotlin.String,
      operationOperation: OperationOperationListNamespaceValues,
      operationValues: kotlin.collections.List<kotlin.String>
  ): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/n/meta/namespace/{Namespace}"
                .replace("{" + "Namespace" + "}", encodeURIComponent(namespace.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = true,
        body = localVariableBody)
  ...
  fun listNamespaces(): RestUserMetaNamespaceCollection {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestUserMetaNamespaceCollection
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  fun listNamespacesWithHttpInfo(): ApiResponse<RestUserMetaNamespaceCollection?> {
    ...
    return request<Unit, RestUserMetaNamespaceCollection>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listVersionsWithHttpInfo(
      uuid: kotlin.String,
      path: kotlin.String?
  ): ApiResponse<RestNodeCollection?> {
    val localVariableConfig = listVersionsRequestConfig(uuid = uuid, path = path)

    return request<Unit, RestNodeCollection>(localVariableConfig)
  }
  ...
  fun lookupWithHttpInfo(body: RestLookupRequest): ApiResponse<RestNodeCollection?> {
    ...
    return request<RestLookupRequest, RestNodeCollection>(localVariableConfig)
  }
  ...
  /**
   * PatchNode is used to update a node specific meta. It is used for reserved meta as well
   * (bookmarks, contentLock)
   *
   * @param uuid
   * @param nodeUpdates
   * @return RestNode
   ...
   * @return RequestConfig
   */
  fun patchNodeRequestConfig(
      uuid: kotlin.String,
      nodeUpdates: RestNodeUpdates
  ): RequestConfig<RestNodeUpdates> {
  ...
  @Throws(
      ...
      ServerException::class)
  fun performAction(
      name: NamePerformAction,
      parameters: RestActionParameters,
      jobUuid: kotlin.String? = null
  ): RestPerformActionResponse {
    val localVarResponse =
        performActionWithHttpInfo(name = name, parameters = parameters, jobUuid = jobUuid)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun performActionWithHttpInfo(
      name: NamePerformAction,
      parameters: RestActionParameters,
      jobUuid: kotlin.String?
  ): ApiResponse<RestPerformActionResponse?> {
    val localVariableConfig =
        performActionRequestConfig(name = name, parameters = parameters, jobUuid = jobUuid)

    return request<RestActionParameters, RestPerformActionResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun performActionRequestConfig(
      name: NamePerformAction,
      parameters: RestActionParameters,
      jobUuid: kotlin.String?
  ): RequestConfig<RestActionParameters> {
  ...
  fun searchMetaWithHttpInfo(body: IdmSearchUserMetaRequest): ApiResponse<RestUserMetaList?> {
    ...
    return request<IdmSearchUserMetaRequest, RestUserMetaList>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun searchMetaRequestConfig(
      body: IdmSearchUserMetaRequest
  ): RequestConfig<IdmSearchUserMetaRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun updateNamespaceValues(
      namespace: kotlin.String,
      operation: RestNamespaceValuesOperation
  ): RestNamespaceValuesResponse {
    val localVarResponse =
        updateNamespaceValuesWithHttpInfo(namespace = namespace, operation = operation)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun updateNamespaceValuesWithHttpInfo(
      namespace: kotlin.String,
      operation: RestNamespaceValuesOperation
  ): ApiResponse<RestNamespaceValuesResponse?> {
    val localVariableConfig =
        updateNamespaceValuesRequestConfig(namespace = namespace, operation = operation)

    return request<RestNamespaceValuesOperation, RestNamespaceValuesResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun updateNamespaceValuesRequestConfig(
      namespace: kotlin.String,
      operation: RestNamespaceValuesOperation
  ): RequestConfig<RestNamespaceValuesOperation> {
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun updatePublicLink(
      linkUuid: kotlin.String,
      publicLinkRequest: RestPublicLinkRequest
  ): RestShareLink {
    val localVarResponse =
        updatePublicLinkWithHttpInfo(linkUuid = linkUuid, publicLinkRequest = publicLinkRequest)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun updatePublicLinkWithHttpInfo(
      linkUuid: kotlin.String,
      publicLinkRequest: RestPublicLinkRequest
  ): ApiResponse<RestShareLink?> {
    val localVariableConfig =
        updatePublicLinkRequestConfig(linkUuid = linkUuid, publicLinkRequest = publicLinkRequest)
   ...
   * @return RequestConfig
   */
  fun updatePublicLinkRequestConfig(
      linkUuid: kotlin.String,
      publicLinkRequest: RestPublicLinkRequest
  ): RequestConfig<RestPublicLinkRequest> {
    val localVariableBody = publicLinkRequest
  ...
  /**
   * Special API for Bookmarks, will load userMeta and the associated nodes, and return as a node
   * list
   *
   * @param all (optional)
   * @return RestNodeCollection
