...
import com.pydio.kotlin.openapi.model.IdmUpdateUserMetaNamespaceRequest
import com.pydio.kotlin.openapi.model.IdmUpdateUserMetaNamespaceResponse
import com.pydio.kotlin.openapi.model.IdmUpdateUserMetaRequest
import com.pydio.kotlin.openapi.model.IdmUpdateUserMetaResponse
import com.pydio.kotlin.openapi.model.RestBulkMetaResponse
import com.pydio.kotlin.openapi.model.RestDeleteUserMetaTagsResponse
import com.pydio.kotlin.openapi.model.RestListUserMetaTagsResponse
import com.pydio.kotlin.openapi.model.RestPutUserMetaTagRequest
import com.pydio.kotlin.openapi.model.RestPutUserMetaTagResponse
import com.pydio.kotlin.openapi.model.RestUserBookmarksRequest
import com.pydio.kotlin.openapi.model.RestUserMetaCollection
...
class UserMetaServiceApi(
  ...
  fun deleteUserMetaTags(
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestDeleteUserMetaTagsResponse
  ...
  fun deleteUserMetaTagsWithHttpInfo(
      namespace: kotlin.String,
      tags: kotlin.String
  ): ApiResponse<RestDeleteUserMetaTagsResponse?> {
    val localVariableConfig = deleteUserMetaTagsRequestConfig(namespace = namespace, tags = tags)

    return request<Unit, RestDeleteUserMetaTagsResponse>(localVariableConfig)
  }
   ...
   */
  fun deleteUserMetaTagsRequestConfig(
      namespace: kotlin.String,
      tags: kotlin.String
  ): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/user-meta/tags/{Namespace}/{Tags}"
                ...
                .replace("{" + "Tags" + "}", encodeURIComponent(tags.toString())),
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listUserMetaTagsWithHttpInfo(
      namespace: kotlin.String
  ): ApiResponse<RestListUserMetaTagsResponse?> {
    val localVariableConfig = listUserMetaTagsRequestConfig(namespace = namespace)

    return request<Unit, RestListUserMetaTagsResponse>(localVariableConfig)
  }
  ...
  fun putUserMetaTag(
      namespace: kotlin.String,
      body: RestPutUserMetaTagRequest
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun putUserMetaTagWithHttpInfo(
      namespace: kotlin.String,
      body: RestPutUserMetaTagRequest
  ): ApiResponse<RestPutUserMetaTagResponse?> {
    val localVariableConfig = putUserMetaTagRequestConfig(namespace = namespace, body = body)

    return request<RestPutUserMetaTagRequest, RestPutUserMetaTagResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun putUserMetaTagRequestConfig(
      namespace: kotlin.String,
      body: RestPutUserMetaTagRequest
  ): RequestConfig<RestPutUserMetaTagRequest> {
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun searchUserMetaWithHttpInfo(
      body: IdmSearchUserMetaRequest
  ): ApiResponse<RestUserMetaCollection?> {
    val localVariableConfig = searchUserMetaRequestConfig(body = body)

    return request<IdmSearchUserMetaRequest, RestUserMetaCollection>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun searchUserMetaRequestConfig(
      body: IdmSearchUserMetaRequest
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun updateUserMetaWithHttpInfo(
      body: IdmUpdateUserMetaRequest
  ): ApiResponse<IdmUpdateUserMetaResponse?> {
    val localVariableConfig = updateUserMetaRequestConfig(body = body)

    return request<IdmUpdateUserMetaRequest, IdmUpdateUserMetaResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun updateUserMetaRequestConfig(
      body: IdmUpdateUserMetaRequest
  ): RequestConfig<IdmUpdateUserMetaRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun updateUserMetaNamespace(
      body: IdmUpdateUserMetaNamespaceRequest
  ): IdmUpdateUserMetaNamespaceResponse {
    val localVarResponse = updateUserMetaNamespaceWithHttpInfo(body = body)

    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as IdmUpdateUserMetaNamespaceResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun updateUserMetaNamespaceWithHttpInfo(
      body: IdmUpdateUserMetaNamespaceRequest
  ): ApiResponse<IdmUpdateUserMetaNamespaceResponse?> {
   ...
   * @return RequestConfig
   */
  fun updateUserMetaNamespaceRequestConfig(
      body: IdmUpdateUserMetaNamespaceRequest
  ): RequestConfig<IdmUpdateUserMetaNamespaceRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun userBookmarksWithHttpInfo(
      body: RestUserBookmarksRequest
  ): ApiResponse<RestBulkMetaResponse?> {
    val localVariableConfig = userBookmarksRequestConfig(body = body)

    return request<RestUserBookmarksRequest, RestBulkMetaResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun userBookmarksRequestConfig(
      body: RestUserBookmarksRequest
  ): RequestConfig<RestUserBookmarksRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
