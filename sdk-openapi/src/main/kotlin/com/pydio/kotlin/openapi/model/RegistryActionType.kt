...
enum class RegistryActionType(val value: kotlin.String) {
  ...
  @Json(name = "FULL_DIFF") FULL_DIFF("FULL_DIFF"),
  @Json(name = "FULL_LIST") FULL_LIST("FULL_LIST"),
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? =
        if (data is RegistryActionType) "$data" else null

    /** Returns a valid [RegistryActionType] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): RegistryActionType? =
        data?.let {
