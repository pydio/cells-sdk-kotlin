...
enum class ActivityObjectType(val value: kotlin.String) {
  ...
  @Json(name = "OrderedCollection") OrderedCollection("OrderedCollection"),
  @Json(name = "CollectionPage") CollectionPage("CollectionPage"),
  @Json(name = "OrderedCollectionPage") OrderedCollectionPage("OrderedCollectionPage"),
  ...
  @Json(name = "Article") Article("Article"),
  ...
  @Json(name = "TentativeReject") TentativeReject("TentativeReject"),
  @Json(name = "TentativeAccept") TentativeAccept("TentativeAccept"),
  @Json(name = "Travel") Travel("Travel"),
  @Json(name = "Undo") Undo("Undo"),
  @Json(name = "Update") Update("Update"),
  @Json(name = "UpdateComment") UpdateComment("UpdateComment"),
  @Json(name = "UpdateMeta") UpdateMeta("UpdateMeta"),
  @Json(name = "View") View("View"),
  @Json(name = "Workspace") Workspace("Workspace"),
  @Json(name = "Digest") Digest("Digest"),
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? =
        if (data is ActivityObjectType) "$data" else null

    /** Returns a valid [ActivityObjectType] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): ActivityObjectType? =
        data?.let {
