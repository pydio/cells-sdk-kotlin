...
class TreeServiceApi(
   ...
   */
  fun bulkStatNodesRequestConfig(
  ...
  fun createNodesWithHttpInfo(body: RestCreateNodesRequest): ApiResponse<RestNodesCollection?> {
    ...
    return request<RestCreateNodesRequest, RestNodesCollection>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun createNodesRequestConfig(
      body: RestCreateNodesRequest
  ): RequestConfig<RestCreateNodesRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun createSelectionWithHttpInfo(
      body: RestCreateSelectionRequest
  ): ApiResponse<RestCreateSelectionResponse?> {
    val localVariableConfig = createSelectionRequestConfig(body = body)

    return request<RestCreateSelectionRequest, RestCreateSelectionResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun createSelectionRequestConfig(
      body: RestCreateSelectionRequest
  ): RequestConfig<RestCreateSelectionRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun deleteNodesWithHttpInfo(body: RestDeleteNodesRequest): ApiResponse<RestDeleteNodesResponse?> {
    ...
    return request<RestDeleteNodesRequest, RestDeleteNodesResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun deleteNodesRequestConfig(
      body: RestDeleteNodesRequest
  ): RequestConfig<RestDeleteNodesRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun headNodeWithHttpInfo(node: kotlin.String): ApiResponse<RestHeadNodeResponse?> {
    ...
    return request<Unit, RestHeadNodeResponse>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun restoreNodesWithHttpInfo(
      body: RestRestoreNodesRequest
  ): ApiResponse<RestRestoreNodesResponse?> {
    val localVariableConfig = restoreNodesRequestConfig(body = body)

    return request<RestRestoreNodesRequest, RestRestoreNodesResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun restoreNodesRequestConfig(
      body: RestRestoreNodesRequest
  ): RequestConfig<RestRestoreNodesRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
