...
data class TreeListNodesRequest(
    @Json(name = "Ancestors") val ancestors: kotlin.Boolean? = null,
    @Json(name = "FilterType") val filterType: TreeNodeType? = TreeNodeType.UNKNOWN,
    ...
    @Json(name = "WithVersions") val withVersions: kotlin.Boolean? = null
) {}
