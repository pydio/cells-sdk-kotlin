...
class ShareServiceApi(
  ...
  fun deleteCellWithHttpInfo(uuid: kotlin.String): ApiResponse<RestDeleteCellResponse?> {
    ...
    return request<Unit, RestDeleteCellResponse>(localVariableConfig)
  }
  ...
  fun deleteCellRequestConfig(uuid: kotlin.String): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/share/cell/{Uuid}".replace("{" + "Uuid" + "}", encodeURIComponent(uuid.toString())),
  ...
  fun deleteShareLinkWithHttpInfo(uuid: kotlin.String): ApiResponse<RestDeleteShareLinkResponse?> {
    ...
    return request<Unit, RestDeleteShareLinkResponse>(localVariableConfig)
  }
  ...
  fun deleteShareLinkRequestConfig(uuid: kotlin.String): RequestConfig<Unit> {
    ...
    return RequestConfig(
        method = RequestMethod.DELETE,
        path =
            "/share/link/{Uuid}".replace("{" + "Uuid" + "}", encodeURIComponent(uuid.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun getCellWithHttpInfo(uuid: kotlin.String): ApiResponse<RestCell?> {
    ...
    return request<Unit, RestCell>(localVariableConfig)
  }
  ...
  fun listSharedResources(body: RestListSharedResourcesRequest): RestListSharedResourcesResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestListSharedResourcesResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listSharedResourcesWithHttpInfo(
      body: RestListSharedResourcesRequest
  ): ApiResponse<RestListSharedResourcesResponse?> {
   ...
   * @return RequestConfig
   */
  fun listSharedResourcesRequestConfig(
      body: RestListSharedResourcesRequest
  ): RequestConfig<RestListSharedResourcesRequest> {
  ...
  fun putCellWithHttpInfo(body: RestPutCellRequest): ApiResponse<RestCell?> {
    ...
    return request<RestPutCellRequest, RestCell>(localVariableConfig)
  }
  ...
  fun putShareLinkWithHttpInfo(body: RestPutShareLinkRequest): ApiResponse<RestShareLink?> {
    ...
    return request<RestPutShareLinkRequest, RestShareLink>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun putShareLinkRequestConfig(
      body: RestPutShareLinkRequest
  ): RequestConfig<RestPutShareLinkRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun updateSharePolicies(body: RestUpdateSharePoliciesRequest): RestUpdateSharePoliciesResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestUpdateSharePoliciesResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun updateSharePoliciesWithHttpInfo(
      body: RestUpdateSharePoliciesRequest
  ): ApiResponse<RestUpdateSharePoliciesResponse?> {
   ...
   * @return RequestConfig
   */
  fun updateSharePoliciesRequestConfig(
      body: RestUpdateSharePoliciesRequest
  ): RequestConfig<RestUpdateSharePoliciesRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
