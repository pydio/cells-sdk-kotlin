...
enum class ListSharedResourcesRequestListShareType(val value: kotlin.String) {
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? =
        if (data is ListSharedResourcesRequestListShareType) "$data" else null

    /** Returns a valid [ListSharedResourcesRequestListShareType] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): ListSharedResourcesRequestListShareType? =
        data?.let {
