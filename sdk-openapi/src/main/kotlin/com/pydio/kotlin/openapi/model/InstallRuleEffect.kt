...
enum class InstallRuleEffect(val value: kotlin.String) {
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? = if (data is InstallRuleEffect) "$data" else null

    /** Returns a valid [InstallRuleEffect] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): InstallRuleEffect? =
        data?.let {
