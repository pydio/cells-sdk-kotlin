...
import com.pydio.kotlin.openapi.model.InstallGetAgreementResponse
import com.pydio.kotlin.openapi.model.InstallGetDefaultsResponse
import com.pydio.kotlin.openapi.model.InstallInstallEventsResponse
import com.pydio.kotlin.openapi.model.InstallInstallRequest
import com.pydio.kotlin.openapi.model.InstallInstallResponse
import com.pydio.kotlin.openapi.model.InstallPerformCheckRequest
import com.pydio.kotlin.openapi.model.InstallPerformCheckResponse
...
class InstallServiceApi(
  ...
  fun getAgreementWithHttpInfo(): ApiResponse<InstallGetAgreementResponse?> {
    ...
    return request<Unit, InstallGetAgreementResponse>(localVariableConfig)
  }
  ...
  fun getInstallWithHttpInfo(): ApiResponse<InstallGetDefaultsResponse?> {
    ...
    return request<Unit, InstallGetDefaultsResponse>(localVariableConfig)
  }
  ...
  fun installEventsWithHttpInfo(): ApiResponse<InstallInstallEventsResponse?> {
    ...
    return request<Unit, InstallInstallEventsResponse>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun performInstallCheckWithHttpInfo(
      body: InstallPerformCheckRequest
  ): ApiResponse<InstallPerformCheckResponse?> {
    val localVariableConfig = performInstallCheckRequestConfig(body = body)

    return request<InstallPerformCheckRequest, InstallPerformCheckResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun performInstallCheckRequestConfig(
      body: InstallPerformCheckRequest
  ): RequestConfig<InstallPerformCheckRequest> {
  ...
  fun postInstallWithHttpInfo(body: InstallInstallRequest): ApiResponse<InstallInstallResponse?> {
    ...
    return request<InstallInstallRequest, InstallInstallResponse>(localVariableConfig)
  }
