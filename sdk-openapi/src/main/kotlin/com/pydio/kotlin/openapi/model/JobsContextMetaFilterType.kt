...
enum class JobsContextMetaFilterType(val value: kotlin.String) {
  ...
  @Json(name = "RequestMeta") RequestMeta("RequestMeta"),
  @Json(name = "ContextUser") ContextUser("ContextUser");
  ...
  companion object {
    ...
    fun encode(data: kotlin.Any?): kotlin.String? =
        if (data is JobsContextMetaFilterType) "$data" else null

    /** Returns a valid [JobsContextMetaFilterType] for [data], null otherwise. */
    fun decode(data: kotlin.Any?): JobsContextMetaFilterType? =
        data?.let {
