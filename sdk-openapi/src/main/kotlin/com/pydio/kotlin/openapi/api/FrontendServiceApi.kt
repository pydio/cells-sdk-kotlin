...
import com.pydio.kotlin.openapi.model.RestFrontBinaryResponse
import com.pydio.kotlin.openapi.model.RestFrontBootConfResponse
import com.pydio.kotlin.openapi.model.RestFrontEnrollAuthRequest
import com.pydio.kotlin.openapi.model.RestFrontEnrollAuthResponse
import com.pydio.kotlin.openapi.model.RestFrontMessagesResponse
import com.pydio.kotlin.openapi.model.RestFrontPluginsResponse
...
import com.pydio.kotlin.openapi.model.RestFrontStateResponse
import com.pydio.kotlin.openapi.model.RestSettingsMenuResponse
...
class FrontendServiceApi(
  ...
  fun frontBootConfWithHttpInfo(): ApiResponse<RestFrontBootConfResponse?> {
    ...
    return request<Unit, RestFrontBootConfResponse>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun frontEnrollAuthWithHttpInfo(
      body: RestFrontEnrollAuthRequest
  ): ApiResponse<RestFrontEnrollAuthResponse?> {
    val localVariableConfig = frontEnrollAuthRequestConfig(body = body)

    return request<RestFrontEnrollAuthRequest, RestFrontEnrollAuthResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun frontEnrollAuthRequestConfig(
      body: RestFrontEnrollAuthRequest
  ): RequestConfig<RestFrontEnrollAuthRequest> {
  ...
  fun frontMessagesWithHttpInfo(lang: kotlin.String): ApiResponse<RestFrontMessagesResponse?> {
    ...
    return request<Unit, RestFrontMessagesResponse>(localVariableConfig)
  }
    ...
    return RequestConfig(
        ...
        path =
            "/frontend/messages/{Lang}"
                .replace("{" + "Lang" + "}", encodeURIComponent(lang.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun frontPluginsWithHttpInfo(lang: kotlin.String): ApiResponse<RestFrontPluginsResponse?> {
    ...
    return request<Unit, RestFrontPluginsResponse>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun frontPutBinaryWithHttpInfo(
      binaryType: kotlin.String,
      uuid: kotlin.String
  ): ApiResponse<RestFrontBinaryResponse?> {
    val localVariableConfig = frontPutBinaryRequestConfig(binaryType = binaryType, uuid = uuid)

    return request<Unit, RestFrontBinaryResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun frontPutBinaryRequestConfig(
      binaryType: kotlin.String,
      uuid: kotlin.String
  ): RequestConfig<Unit> {
    val localVariableBody = null
    ...
    return RequestConfig(
        ...
        path =
            "/frontend/binaries/{BinaryType}/{Uuid}"
                .replace("{" + "BinaryType" + "}", encodeURIComponent(binaryType.toString()))
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun frontServeBinaryWithHttpInfo(
      binaryType: kotlin.String,
      uuid: kotlin.String
  ): ApiResponse<RestFrontBinaryResponse?> {
   ...
   * @return RequestConfig
   */
  fun frontServeBinaryRequestConfig(
      binaryType: kotlin.String,
      uuid: kotlin.String
  ): RequestConfig<Unit> {
    val localVariableBody = null
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun frontSessionWithHttpInfo(
      body: RestFrontSessionRequest
  ): ApiResponse<RestFrontSessionResponse?> {
    val localVariableConfig = frontSessionRequestConfig(body = body)

    return request<RestFrontSessionRequest, RestFrontSessionResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun frontSessionRequestConfig(
      body: RestFrontSessionRequest
  ): RequestConfig<RestFrontSessionRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun frontStateWithHttpInfo(xpath: kotlin.String?): ApiResponse<RestFrontStateResponse?> {
    ...
    return request<Unit, RestFrontStateResponse>(localVariableConfig)
  }
  ...
  fun settingsMenuWithHttpInfo(): ApiResponse<RestSettingsMenuResponse?> {
    ...
    return request<Unit, RestSettingsMenuResponse>(localVariableConfig)
  }
