...
class PolicyServiceApi(
  ...
  fun listPoliciesWithHttpInfo(
      body: IdmListPolicyGroupsRequest
  ): ApiResponse<IdmListPolicyGroupsResponse?> {
    val localVariableConfig = listPoliciesRequestConfig(body = body)

    return request<IdmListPolicyGroupsRequest, IdmListPolicyGroupsResponse>(localVariableConfig)
  }
  ...
  fun listPoliciesRequestConfig(
      body: IdmListPolicyGroupsRequest
  ): RequestConfig<IdmListPolicyGroupsRequest> {
