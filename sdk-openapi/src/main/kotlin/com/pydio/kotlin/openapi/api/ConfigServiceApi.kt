...
import com.pydio.kotlin.openapi.model.ConfigServicePutConfigBody
import com.pydio.kotlin.openapi.model.ConfigServicePutDataSourceBody
import com.pydio.kotlin.openapi.model.CtlService
import com.pydio.kotlin.openapi.model.EncryptionAdminCreateKeyRequest
import com.pydio.kotlin.openapi.model.EncryptionAdminCreateKeyResponse
import com.pydio.kotlin.openapi.model.EncryptionAdminDeleteKeyRequest
import com.pydio.kotlin.openapi.model.EncryptionAdminDeleteKeyResponse
import com.pydio.kotlin.openapi.model.EncryptionAdminExportKeyRequest
import com.pydio.kotlin.openapi.model.EncryptionAdminExportKeyResponse
import com.pydio.kotlin.openapi.model.EncryptionAdminImportKeyRequest
import com.pydio.kotlin.openapi.model.EncryptionAdminImportKeyResponse
import com.pydio.kotlin.openapi.model.EncryptionAdminListKeysRequest
import com.pydio.kotlin.openapi.model.EncryptionAdminListKeysResponse
import com.pydio.kotlin.openapi.model.ObjectDataSource
import com.pydio.kotlin.openapi.model.RegistryListRequest
import com.pydio.kotlin.openapi.model.RegistryListResponse
import com.pydio.kotlin.openapi.model.RestConfiguration
import com.pydio.kotlin.openapi.model.RestControlServiceRequest
import com.pydio.kotlin.openapi.model.RestCreatePeerFolderRequest
import com.pydio.kotlin.openapi.model.RestCreatePeerFolderResponse
import com.pydio.kotlin.openapi.model.RestCreateStorageBucketRequest
import com.pydio.kotlin.openapi.model.RestCreateStorageBucketResponse
import com.pydio.kotlin.openapi.model.RestDataSourceCollection
import com.pydio.kotlin.openapi.model.RestDeleteDataSourceResponse
import com.pydio.kotlin.openapi.model.RestDiscoveryResponse
import com.pydio.kotlin.openapi.model.RestListPeerFoldersRequest
import com.pydio.kotlin.openapi.model.RestListPeersAddressesResponse
import com.pydio.kotlin.openapi.model.RestListProcessesRequest
import com.pydio.kotlin.openapi.model.RestListProcessesResponse
import com.pydio.kotlin.openapi.model.RestListSitesResponse
import com.pydio.kotlin.openapi.model.RestListStorageBucketsRequest
import com.pydio.kotlin.openapi.model.RestNodesCollection
import com.pydio.kotlin.openapi.model.RestOpenApiResponse
import com.pydio.kotlin.openapi.model.RestSchedulerActionFormResponse
import com.pydio.kotlin.openapi.model.RestSchedulerActionsResponse
import com.pydio.kotlin.openapi.model.RestServiceCollection
import com.pydio.kotlin.openapi.model.RestVersioningPolicyCollection
...
class ConfigServiceApi(
  ...
  fun configFormsDiscoveryWithHttpInfo(
      serviceName: kotlin.String
  ): ApiResponse<RestDiscoveryResponse?> {
    val localVariableConfig = configFormsDiscoveryRequestConfig(serviceName = serviceName)

    return request<Unit, RestDiscoveryResponse>(localVariableConfig)
  }
  ...
  fun controlServiceWithHttpInfo(body: RestControlServiceRequest): ApiResponse<CtlService?> {
    ...
    return request<RestControlServiceRequest, CtlService>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun controlServiceRequestConfig(
      body: RestControlServiceRequest
  ): RequestConfig<RestControlServiceRequest> {
  ...
  fun createEncryptionKey(body: EncryptionAdminCreateKeyRequest): EncryptionAdminCreateKeyResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as EncryptionAdminCreateKeyResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun createEncryptionKeyWithHttpInfo(
      body: EncryptionAdminCreateKeyRequest
  ): ApiResponse<EncryptionAdminCreateKeyResponse?> {
   ...
   * @return RequestConfig
   */
  fun createEncryptionKeyRequestConfig(
      body: EncryptionAdminCreateKeyRequest
  ): RequestConfig<EncryptionAdminCreateKeyRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun createPeerFolder(
      peerAddress: kotlin.String,
      body: RestCreatePeerFolderRequest
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun createPeerFolderWithHttpInfo(
      peerAddress: kotlin.String,
      body: RestCreatePeerFolderRequest
  ): ApiResponse<RestCreatePeerFolderResponse?> {
    val localVariableConfig = createPeerFolderRequestConfig(peerAddress = peerAddress, body = body)

    return request<RestCreatePeerFolderRequest, RestCreatePeerFolderResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun createPeerFolderRequestConfig(
      peerAddress: kotlin.String,
      body: RestCreatePeerFolderRequest
  ): RequestConfig<RestCreatePeerFolderRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
    ...
    return RequestConfig(
        ...
        path =
            "/config/peers/{PeerAddress}"
                .replace("{" + "PeerAddress" + "}", encodeURIComponent(peerAddress.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun createStorageBucketWithHttpInfo(
      bucketName: kotlin.String,
      body: RestCreateStorageBucketRequest
  ): ApiResponse<RestCreateStorageBucketResponse?> {
   ...
   * @return RequestConfig
   */
  fun createStorageBucketRequestConfig(
      bucketName: kotlin.String,
      body: RestCreateStorageBucketRequest
  ): RequestConfig<RestCreateStorageBucketRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
    ...
    return RequestConfig(
        ...
        path =
            "/config/buckets/{BucketName}"
                .replace("{" + "BucketName" + "}", encodeURIComponent(bucketName.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
   ...
   * @param storageType Type of underlying storage (LOCAL, S3, AZURE, GCS) (optional, default to
   *   LOCAL)
   * @param storageConfiguration List of key values describing storage configuration This is a
   *   request variable of the map type. The query format is \&quot;map_name[key]&#x3D;value\&quot;,
   *   e.g. If the map name is Age, the key type is string, and the value type is integer, the query
   *   parameter is expressed as Age[\&quot;bob\&quot;]&#x3D;18 (optional)
   ...
   * @param encryptionMode Type of encryption applied before sending data to storage (optional,
   *   default to CLEAR)
   * @param encryptionKey Encryption key used for encrypting data (optional)
   * @param versioningPolicyName Versioning policy describes how files are kept in the versioning
   *   queue (optional)
  ...
  fun deleteDataSource(
      name: kotlin.String,
      disabled: kotlin.Boolean? = null,
      storageType: StorageTypeDeleteDataSource? = StorageTypeDeleteDataSource.LOCAL,
      storageConfiguration: kotlin.String? = null,
      objectsServiceName: kotlin.String? = null,
      objectsHost: kotlin.String? = null,
      objectsPort: kotlin.Int? = null,
      objectsSecure: kotlin.Boolean? = null,
      objectsBucket: kotlin.String? = null,
      objectsBaseFolder: kotlin.String? = null,
      apiKey: kotlin.String? = null,
      apiSecret: kotlin.String? = null,
      peerAddress: kotlin.String? = null,
      watch: kotlin.Boolean? = null,
      flatStorage: kotlin.Boolean? = null,
      skipSyncOnRestart: kotlin.Boolean? = null,
      encryptionMode: EncryptionModeDeleteDataSource? = EncryptionModeDeleteDataSource.CLEAR,
      encryptionKey: kotlin.String? = null,
      versioningPolicyName: kotlin.String? = null,
      creationDate: kotlin.Int? = null,
      lastSynchronizationDate: kotlin.Int? = null
    ...
    val localVarResponse =
        deleteDataSourceWithHttpInfo(
            ...
            objectsServiceName = objectsServiceName,
            objectsHost = objectsHost,
            objectsPort = objectsPort,
            objectsSecure = objectsSecure,
            objectsBucket = objectsBucket,
            objectsBaseFolder = objectsBaseFolder,
            apiKey = apiKey,
            apiSecret = apiSecret,
            peerAddress = peerAddress,
            watch = watch,
            flatStorage = flatStorage,
            skipSyncOnRestart = skipSyncOnRestart,
            encryptionMode = encryptionMode,
            encryptionKey = encryptionKey,
            versioningPolicyName = versioningPolicyName,
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun deleteDataSourceWithHttpInfo(
      name: kotlin.String,
      disabled: kotlin.Boolean?,
      storageType: StorageTypeDeleteDataSource?,
      storageConfiguration: kotlin.String?,
      objectsServiceName: kotlin.String?,
      objectsHost: kotlin.String?,
      objectsPort: kotlin.Int?,
      objectsSecure: kotlin.Boolean?,
      objectsBucket: kotlin.String?,
      objectsBaseFolder: kotlin.String?,
      apiKey: kotlin.String?,
      apiSecret: kotlin.String?,
      peerAddress: kotlin.String?,
      watch: kotlin.Boolean?,
      flatStorage: kotlin.Boolean?,
      skipSyncOnRestart: kotlin.Boolean?,
      encryptionMode: EncryptionModeDeleteDataSource?,
      encryptionKey: kotlin.String?,
      versioningPolicyName: kotlin.String?,
      creationDate: kotlin.Int?,
      lastSynchronizationDate: kotlin.Int?
  ): ApiResponse<RestDeleteDataSourceResponse?> {
    val localVariableConfig =
        deleteDataSourceRequestConfig(
            name = name,
            disabled = disabled,
            storageType = storageType,
            storageConfiguration = storageConfiguration,
    ...
    return request<Unit, RestDeleteDataSourceResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun deleteDataSourceRequestConfig(
      name: kotlin.String,
      disabled: kotlin.Boolean?,
      storageType: StorageTypeDeleteDataSource?,
      storageConfiguration: kotlin.String?,
    ...
    val localVariableQuery: MultiValueMap =
        mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
          ...
          if (storageConfiguration != null) {
            put("StorageConfiguration", listOf(storageConfiguration.toString()))
          }
    ...
    return RequestConfig(
        ...
        path =
            "/config/datasource/{Name}"
                .replace("{" + "Name" + "}", encodeURIComponent(name.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun deleteEncryptionKey(body: EncryptionAdminDeleteKeyRequest): EncryptionAdminDeleteKeyResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as EncryptionAdminDeleteKeyResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun deleteEncryptionKeyWithHttpInfo(
      body: EncryptionAdminDeleteKeyRequest
  ): ApiResponse<EncryptionAdminDeleteKeyResponse?> {
   ...
   * @return RequestConfig
   */
  fun deleteEncryptionKeyRequestConfig(
      body: EncryptionAdminDeleteKeyRequest
  ): RequestConfig<EncryptionAdminDeleteKeyRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun endpointsDiscoveryWithHttpInfo(
      endpointType: kotlin.String?
  ): ApiResponse<RestDiscoveryResponse?> {
  ...
  fun exportEncryptionKey(body: EncryptionAdminExportKeyRequest): EncryptionAdminExportKeyResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as EncryptionAdminExportKeyResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun exportEncryptionKeyWithHttpInfo(
      body: EncryptionAdminExportKeyRequest
  ): ApiResponse<EncryptionAdminExportKeyResponse?> {
   ...
   * @return RequestConfig
   */
  fun exportEncryptionKeyRequestConfig(
      body: EncryptionAdminExportKeyRequest
  ): RequestConfig<EncryptionAdminExportKeyRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun getConfigWithHttpInfo(
      fullPath: kotlin.String,
      `data`: kotlin.String?
  ): ApiResponse<RestConfiguration?> {
    val localVariableConfig = getConfigRequestConfig(fullPath = fullPath, `data` = `data`)

    return request<Unit, RestConfiguration>(localVariableConfig)
  }
  ...
  fun getConfigRequestConfig(fullPath: kotlin.String, `data`: kotlin.String?): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/config/{FullPath}"
                .replace("{" + "FullPath" + "}", encodeURIComponent(fullPath.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun getDataSource(
      name: kotlin.String,
      disabled: kotlin.Boolean? = null,
      storageType: StorageTypeGetDataSource? = StorageTypeGetDataSource.LOCAL,
      storageConfiguration: kotlin.String? = null,
      objectsServiceName: kotlin.String? = null,
      objectsHost: kotlin.String? = null,
      objectsPort: kotlin.Int? = null,
      ...
      flatStorage: kotlin.Boolean? = null,
      skipSyncOnRestart: kotlin.Boolean? = null,
      encryptionMode: EncryptionModeGetDataSource? = EncryptionModeGetDataSource.CLEAR,
      encryptionKey: kotlin.String? = null,
      versioningPolicyName: kotlin.String? = null,
      creationDate: kotlin.Int? = null,
      lastSynchronizationDate: kotlin.Int? = null
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun getDataSourceWithHttpInfo(
      name: kotlin.String,
      disabled: kotlin.Boolean?,
      storageType: StorageTypeGetDataSource?,
      storageConfiguration: kotlin.String?,
      objectsServiceName: kotlin.String?,
      objectsHost: kotlin.String?,
      objectsPort: kotlin.Int?,
      ...
      flatStorage: kotlin.Boolean?,
      skipSyncOnRestart: kotlin.Boolean?,
      encryptionMode: EncryptionModeGetDataSource?,
      encryptionKey: kotlin.String?,
      versioningPolicyName: kotlin.String?,
      creationDate: kotlin.Int?,
      lastSynchronizationDate: kotlin.Int?
  ): ApiResponse<ObjectDataSource?> {
    val localVariableConfig =
        getDataSourceRequestConfig(
            name = name,
            disabled = disabled,
            storageType = storageType,
            storageConfiguration = storageConfiguration,
    ...
    return request<Unit, ObjectDataSource>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun getDataSourceRequestConfig(
      name: kotlin.String,
      disabled: kotlin.Boolean?,
      storageType: StorageTypeGetDataSource?,
      storageConfiguration: kotlin.String?,
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun getVersioningPolicy(
      uuid: kotlin.String,
      name: kotlin.String? = null,
      description: kotlin.String? = null,
      versionsDataSourceName: kotlin.String? = null,
      versionsDataSourceBucket: kotlin.String? = null,
      maxTotalSize: kotlin.String? = null,
      maxSizePerFile: kotlin.String? = null,
      ignoreFilesGreaterThan: kotlin.String? = null,
      nodeDeletedStrategy: NodeDeletedStrategyGetVersioningPolicy? =
          NodeDeletedStrategyGetVersioningPolicy.KeepAll
  ): TreeVersioningPolicy {
    val localVarResponse =
        getVersioningPolicyWithHttpInfo(
            uuid = uuid,
            name = name,
            description = description,
            versionsDataSourceName = versionsDataSourceName,
            versionsDataSourceBucket = versionsDataSourceBucket,
            maxTotalSize = maxTotalSize,
            maxSizePerFile = maxSizePerFile,
            ignoreFilesGreaterThan = ignoreFilesGreaterThan,
            nodeDeletedStrategy = nodeDeletedStrategy)
  ...
  fun getVersioningPolicyWithHttpInfo(
      ...
      versionsDataSourceName: kotlin.String?,
      versionsDataSourceBucket: kotlin.String?,
      maxTotalSize: kotlin.String?,
      maxSizePerFile: kotlin.String?,
      ignoreFilesGreaterThan: kotlin.String?,
      nodeDeletedStrategy: NodeDeletedStrategyGetVersioningPolicy?
  ): ApiResponse<TreeVersioningPolicy?> {
    val localVariableConfig =
        getVersioningPolicyRequestConfig(
            uuid = uuid,
            name = name,
            description = description,
            versionsDataSourceName = versionsDataSourceName,
    ...
    return request<Unit, TreeVersioningPolicy>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun getVersioningPolicyRequestConfig(
      uuid: kotlin.String,
      name: kotlin.String?,
      description: kotlin.String?,
      versionsDataSourceName: kotlin.String?,
    ...
    return RequestConfig(
        ...
        path =
            "/config/versioning/{Uuid}"
                .replace("{" + "Uuid" + "}", encodeURIComponent(uuid.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun importEncryptionKey(body: EncryptionAdminImportKeyRequest): EncryptionAdminImportKeyResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as EncryptionAdminImportKeyResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun importEncryptionKeyWithHttpInfo(
      body: EncryptionAdminImportKeyRequest
  ): ApiResponse<EncryptionAdminImportKeyResponse?> {
   ...
   * @return RequestConfig
   */
  fun importEncryptionKeyRequestConfig(
      body: EncryptionAdminImportKeyRequest
  ): RequestConfig<EncryptionAdminImportKeyRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun listDataSourcesWithHttpInfo(): ApiResponse<RestDataSourceCollection?> {
    ...
    return request<Unit, RestDataSourceCollection>(localVariableConfig)
  }
  ...
  fun listEncryptionKeys(body: EncryptionAdminListKeysRequest): EncryptionAdminListKeysResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as EncryptionAdminListKeysResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listEncryptionKeysWithHttpInfo(
      body: EncryptionAdminListKeysRequest
  ): ApiResponse<EncryptionAdminListKeysResponse?> {
   ...
   * @return RequestConfig
   */
  fun listEncryptionKeysRequestConfig(
      body: EncryptionAdminListKeysRequest
  ): RequestConfig<EncryptionAdminListKeysRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun listPeerFolders(
      peerAddress: kotlin.String,
      body: RestListPeerFoldersRequest
  ): RestNodesCollection {
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listPeerFoldersWithHttpInfo(
      peerAddress: kotlin.String,
      body: RestListPeerFoldersRequest
  ): ApiResponse<RestNodesCollection?> {
    val localVariableConfig = listPeerFoldersRequestConfig(peerAddress = peerAddress, body = body)

    return request<RestListPeerFoldersRequest, RestNodesCollection>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun listPeerFoldersRequestConfig(
      peerAddress: kotlin.String,
      body: RestListPeerFoldersRequest
  ): RequestConfig<RestListPeerFoldersRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun listPeersAddresses(): RestListPeersAddressesResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestListPeersAddressesResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  fun listPeersAddressesWithHttpInfo(): ApiResponse<RestListPeersAddressesResponse?> {
    ...
    return request<Unit, RestListPeersAddressesResponse>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listProcessesWithHttpInfo(
      body: RestListProcessesRequest
  ): ApiResponse<RestListProcessesResponse?> {
    val localVariableConfig = listProcessesRequestConfig(body = body)

    return request<RestListProcessesRequest, RestListProcessesResponse>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun listProcessesRequestConfig(
      body: RestListProcessesRequest
  ): RequestConfig<RestListProcessesRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun listRegistryWithHttpInfo(body: RegistryListRequest): ApiResponse<RegistryListResponse?> {
    ...
    return request<RegistryListRequest, RegistryListResponse>(localVariableConfig)
  }
   ...
   *
   * @param statusFilter Filter services by a given status (ANY, STOPPED, STOPPING, RUNNING)
  ...
  @Throws(
      ...
      ServerException::class)
  fun listServices(
      statusFilter: StatusFilterListServices? = StatusFilterListServices.ANY
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listServicesWithHttpInfo(
      statusFilter: StatusFilterListServices?
  ): ApiResponse<RestServiceCollection?> {
    val localVariableConfig = listServicesRequestConfig(statusFilter = statusFilter)

    return request<Unit, RestServiceCollection>(localVariableConfig)
  }
  ...
  fun listSitesWithHttpInfo(filter: kotlin.String): ApiResponse<RestListSitesResponse?> {
    ...
    return request<Unit, RestListSitesResponse>(localVariableConfig)
  }
  ...
  fun listSitesRequestConfig(filter: kotlin.String): RequestConfig<Unit> {
    ...
    return RequestConfig(
        ...
        path =
            "/config/sites/{Filter}"
                .replace("{" + "Filter" + "}", encodeURIComponent(filter.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun listStorageBucketsWithHttpInfo(
      body: RestListStorageBucketsRequest
  ): ApiResponse<RestNodesCollection?> {
    val localVariableConfig = listStorageBucketsRequestConfig(body = body)

    return request<RestListStorageBucketsRequest, RestNodesCollection>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun listStorageBucketsRequestConfig(
      body: RestListStorageBucketsRequest
  ): RequestConfig<RestListStorageBucketsRequest> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun listVersioningPolicies(): RestVersioningPolicyCollection {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestVersioningPolicyCollection
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  fun listVersioningPoliciesWithHttpInfo(): ApiResponse<RestVersioningPolicyCollection?> {
    ...
    return request<Unit, RestVersioningPolicyCollection>(localVariableConfig)
  }
  ...
  fun listVirtualNodesWithHttpInfo(): ApiResponse<RestNodesCollection?> {
    ...
    return request<Unit, RestNodesCollection>(localVariableConfig)
  }
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun openApiDiscoveryWithHttpInfo(
      endpointType: kotlin.String?
  ): ApiResponse<RestOpenApiResponse?> {
    val localVariableConfig = openApiDiscoveryRequestConfig(endpointType = endpointType)

    return request<Unit, RestOpenApiResponse>(localVariableConfig)
  }
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun putConfig(fullPath: kotlin.String, body: ConfigServicePutConfigBody): RestConfiguration {
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun putConfigWithHttpInfo(
      fullPath: kotlin.String,
      body: ConfigServicePutConfigBody
  ): ApiResponse<RestConfiguration?> {
    val localVariableConfig = putConfigRequestConfig(fullPath = fullPath, body = body)

    return request<ConfigServicePutConfigBody, RestConfiguration>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun putConfigRequestConfig(
      fullPath: kotlin.String,
      body: ConfigServicePutConfigBody
  ): RequestConfig<ConfigServicePutConfigBody> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  @Throws(
      ...
      ClientException::class,
      ServerException::class)
  fun putDataSource(name: kotlin.String, body: ConfigServicePutDataSourceBody): ObjectDataSource {
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun putDataSourceWithHttpInfo(
      name: kotlin.String,
      body: ConfigServicePutDataSourceBody
  ): ApiResponse<ObjectDataSource?> {
    val localVariableConfig = putDataSourceRequestConfig(name = name, body = body)

    return request<ConfigServicePutDataSourceBody, ObjectDataSource>(localVariableConfig)
  }
   ...
   * @return RequestConfig
   */
  fun putDataSourceRequestConfig(
      name: kotlin.String,
      body: ConfigServicePutDataSourceBody
  ): RequestConfig<ConfigServicePutDataSourceBody> {
    val localVariableBody = body
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    localVariableHeaders["Content-Type"] = "application/json"
  ...
  fun schedulerActionFormDiscovery(actionName: kotlin.String): RestSchedulerActionFormResponse {
    ...
    return when (localVarResponse.responseType) {
      ResponseType.Success ->
          (localVarResponse as Success<*>).data as RestSchedulerActionFormResponse
      ResponseType.Informational ->
          throw UnsupportedOperationException("Client does not support Informational responses.")
      ResponseType.Redirection ->
          throw UnsupportedOperationException("Client does not support Redirection responses.")
  ...
  @Suppress("UNCHECKED_CAST")
  @Throws(IllegalStateException::class, IOException::class)
  fun schedulerActionFormDiscoveryWithHttpInfo(
      actionName: kotlin.String
  ): ApiResponse<RestSchedulerActionFormResponse?> {
    val localVariableConfig = schedulerActionFormDiscoveryRequestConfig(actionName = actionName)

    return request<Unit, RestSchedulerActionFormResponse>(localVariableConfig)
  }
    ...
    return RequestConfig(
        ...
        path =
            "/config/scheduler/actions/{ActionName}"
                .replace("{" + "ActionName" + "}", encodeURIComponent(actionName.toString())),
        query = localVariableQuery,
        headers = localVariableHeaders,
        requiresAuthentication = false,
        body = localVariableBody)
  ...
  fun schedulerActionsDiscoveryWithHttpInfo(): ApiResponse<RestSchedulerActionsResponse?> {
    ...
    return request<Unit, RestSchedulerActionsResponse>(localVariableConfig)
  }
