 ...
 * @param userRole
 */
data class RoleServiceSetRoleBody(
    @Json(name = "AutoApplies") val autoApplies: kotlin.collections.List<kotlin.String>? = null,

    /* Is used in a stack of roles, this one will always be applied last. */
    @Json(name = "ForceOverride") val forceOverride: kotlin.Boolean? = null,
    @Json(name = "GroupRole") val groupRole: kotlin.Boolean? = null,
    @Json(name = "IsTeam") val isTeam: kotlin.Boolean? = null,
    ...
    @Json(name = "UserRole") val userRole: kotlin.Boolean? = null
) {}
