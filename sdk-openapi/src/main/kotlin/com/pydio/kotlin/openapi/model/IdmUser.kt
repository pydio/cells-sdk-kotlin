...
data class IdmUser(
    ...
    @Json(name = "GroupLabel") val groupLabel: kotlin.String? = null,
    @Json(name = "GroupPath") val groupPath: kotlin.String? = null,
    @Json(name = "IsGroup") val isGroup: kotlin.Boolean? = null,
    @Json(name = "LastConnected") val lastConnected: kotlin.Int? = null,
    @Json(name = "Login") val login: kotlin.String? = null,
    @Json(name = "OldPassword") val oldPassword: kotlin.String? = null,
