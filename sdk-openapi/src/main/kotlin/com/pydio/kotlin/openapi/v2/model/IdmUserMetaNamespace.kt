...
data class IdmUserMetaNamespace(
    @Json(name = "Indexable") val indexable: kotlin.Boolean? = null,
    @Json(name = "JsonDefinition") val jsonDefinition: kotlin.String? = null,
    @Json(name = "Label") val label: kotlin.String? = null,
    @Json(name = "Namespace") val namespace: kotlin.String? = null,
    @Json(name = "Order") val order: kotlin.Int? = null,
