...
class ConfigServicePutDataSourceBodyTest : ShouldSpec() {
  init {
    // uncomment below to create an instance of ConfigServicePutDataSourceBody
    // val modelInstance = ConfigServicePutDataSourceBody()
