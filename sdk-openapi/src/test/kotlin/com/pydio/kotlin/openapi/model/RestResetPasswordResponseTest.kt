...
class RestResetPasswordResponseTest : ShouldSpec() {
  init {
    // uncomment below to create an instance of RestResetPasswordResponse
    // val modelInstance = RestResetPasswordResponse()
